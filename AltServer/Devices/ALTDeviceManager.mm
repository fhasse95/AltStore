...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        _installationQueue = dispatch_queue_create("com.rileytestut.AltServer.iPad.Installation", DISPATCH_QUEUE_SERIAL);
        _devicesQueue = dispatch_queue_create("com.rileytestut.AltServer.iPad.Devices", DISPATCH_QUEUE_CONCURRENT_WITH_AUTORELEASE_POOL);
